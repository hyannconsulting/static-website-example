...
3. **ID** : `SSH_AUTH_SERVER` (utilisé pour staging et production).
4. **Username** : `ubuntu`.
...
```
http://ec2-54-226-234-15.compute-1.amazonaws.com:8090
```
...
```
http://ec2-13-222-142-249.compute-1.amazonaws.com:8090
```
